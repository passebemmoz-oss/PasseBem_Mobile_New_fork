...
function HistQuizScreen({navigation}) {
    ...
    useEffect(() => {
        ...
        api.get(`respstaprovamodular/${item._id}`,{item})
            .then(res => {
    ...
    return (
        ...
        <SafeAreaView style={{backgroundColor:"#f0f4fd", flex:1, position:"relative"}}>
            ...
            <View style={{flexDirection:"row", justifyContent:"space-between", alignItems:"center", 
                ...
                {/* ProgressBar ocultado para evitar erros de precisão aritmética */}
                <View style={{height:8, width:Math.round(width*0.76), backgroundColor:"#e0e0e0", borderRadius:20}} />
